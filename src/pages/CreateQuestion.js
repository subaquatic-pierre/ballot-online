                    ...
                    <Card className={classes.card}>
                        <form className={classes.form} noValidate autoComplete='off'>
                            <FormControl margin='normal' color='primary' component="fieldset">
                                ...
                                <RadioGroup aria-label="gender" name="gender1" value={questionType} onChange={handleChoiceTypeChange}>
                                    <FormControlLabel value="2C" control={<Radio />} label="Two Choices" />
                                    <FormControlLabel value="MC" control={<Radio />} label="Multiple Choices" />
                                </RadioGroup>
                            </FormControl>
                            ...
                            <FormControl margin='normal' fullWidth component="fieldset">
                                    ...
                                    {choices.map((choice, index) => {
                                        return (
                                            <ListItem key={index}>
                                                ...
                                                />
                                                <ListItemSecondaryAction>
                                                    <IconButton edge="end" onClick={() => handleRemoveChoice(index)} aria-label="delete">
                                                        <DeleteIcon />
                                                    </IconButton>
                                                </ListItemSecondaryAction>
                                            </ListItem>
                                ...
                                <TextField
                                    ...
                                    label="Choice" />
                                <Button className={classes.button} size='small' variant='contained' color='primary' onClick={handleAddChoice}>Add Choice</Button>
                            </FormControl>
                        </form>
                        <Button className={classes.button} variant='contained' color='secondary' onClick={handleCreateClick}>Create</Button>
                    </Card>
                </Grid>
            </Grid>
        </>
